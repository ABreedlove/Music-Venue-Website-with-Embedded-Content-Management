...
function renderContent($db, $id, $col) {
	...
	$sql = "SELECT * FROM venue_database.event_singles WHERE ID = " . $GLOBALS['event_id'];
    ...
    <div class="row align-items-center">
        ...
        <div class="portfolio-single-slider">
          <div><img class="img-fluid" src=<?php renderContent($db, $GLOBALS["event_id"], "img"); ?>></div>
				...
				<?php if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) {}
					...
					<form action="upload_event_singles_img.php" method="POST" enctype="multipart/form-data" style="display: none;">
      ...
      <div class="col-xl-4 col-lg-5 mt-5 mt-lg-0">
        <div class="project-details">
          <h4>Event Details</h4>
          <ul>
						<form action="post_event_singles.php?event_id=<?php $GLOBALS['event_id']?>" method="POST">
