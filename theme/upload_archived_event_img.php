...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$sql = "UPDATE venue_database.archived_events SET event_img = " . $file_name_quotes . " WHERE ID = " . $rid[$i];
	...
	$img_paths = array();
	$sql = "SELECT event_img FROM venue_database.archived_events WHERE feature_img = 1";
