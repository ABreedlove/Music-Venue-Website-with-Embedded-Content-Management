...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
	...
	$sql = "UPDATE venue_database.archived_event_singles SET event_img = " . $file_name_quotes . " WHERE ID = " . $rid[$i];
...
header("location: archived-event-single.php?event_id=".$rid[$i]);
?>