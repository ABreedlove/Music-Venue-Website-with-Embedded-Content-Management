...
function renderContent($db, $id) {
	...
	$sql = "SELECT * FROM venue_database.archived_events WHERE ID = " . $id;
	...
	echo '<div class="col-lg-4 col-sm-6 portfolio-item shuffle-item" data-groups="[&quot;design&quot;]">
              ...
              <div class="portfolio-hover">
                <div class="portfolio-content">
									<form action="post_archived_event.php" method="POST">
                  ...
                  <p>'. $subtitle .'</p>
									...
									<form action="upload_archived_event_img.php" method="POST" enctype="multipart/form-data" >
									...
									<form action="delete_archived_event.php?event_id='.$global_rid.'" method="POST" onsubmit="return confirm('."'Do you really want to delete the event?'".');">
      ...
      <div class="col-md-12">
        <div class="block">
          ...
          <div class="row shuffle-wrapper">
					...
					<form action="new_archived_event.php" method="POST">
					<?php
					if (!isset($_SESSION["loggedin"]) || $_SESSION["loggedin"] !== true) { }
